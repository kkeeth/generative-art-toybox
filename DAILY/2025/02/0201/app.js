  ...
  for (let x = g / 2; x < width; x += g) {
    for (let y = g / 2; y < width; y += g) {
      ...
      if (d === 0) {
        ...
        let d2 = int(random(4));
        if (d2 === 0) {
          triangle(x - g / 2, y - g / 2, x + g / 2, y, x - g / 2, y + g / 2);
        }
        if (d2 === 1) {
          triangle(x - g / 2, y - g / 2, x + g / 2, y - g / 2, x, y + g / 2);
        }
        if (d2 === 2) {
          triangle(x - g / 2, y, x + g / 2, y - g / 2, x + g / 2, y + g / 2);
        }
        if (d2 === 3) {
          triangle(x, y - g / 2, x + g / 2, y + g / 2, x - g / 2, y + g / 2);
        }
      } else if (d === 4) {
        push();
        let d3 = int(random(4));
