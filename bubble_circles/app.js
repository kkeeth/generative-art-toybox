...
// color pattern
const cp = ["#ffb6b9", "#bbded6", "#fae3d9", "#8ac6d1", "#fff1ac", "#f9bcdd", "#d5a4cf", "#b689b0"]
// count circle
...
function draw() {
  ...
  drawCircles(incSmall, targetCountSmall, rSmall, weightSmall, targetColorSmall, "small")
  drawCircles(incMedium, targetCountMedium, rMedium, weightMedium, targetColorMedium, "medium")
  drawCircles(incLarge, targetCountLarge, rLarge, weightLarge, targetColorLarge, "large")
}
