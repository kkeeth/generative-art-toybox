...
function RectTrail(x, y, z, len, col, a, isRotated) {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    const vx = cos(angle + a) * this.len;
    const vy = sin(angle + a) * this.len;
    const vz = 0.0;
